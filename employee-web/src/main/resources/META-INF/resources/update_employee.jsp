			...
			<aui:form action="${updateEmployeeActionURL}" name="employeeForm"
				...
				<div class="row">
					...
					<aui:input name="employeeId" type="hidden"
						value="<%=Long.parseLong(employeeId)%>">
					</aui:input>

					<div class="col-md-6">
						<fieldset class="form-group">
							<aui:input name="firstName" class="form-element"
								cssClass="form-element" value="${employee.firstName}"
					...
					<div class="col-md-6">
						<fieldset class="form-group">
							<aui:input name="lastName" class="form-element"
								value="${employee.lastName}" cssClass="form-element"
				...
				<aui:input name="designation" class="form-element-designation"
					value="${employee.designation}" cssClass="form-element-designation"
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<aui:input name="emailAddress" class="form-element"
							value="${employee.emailAddress}" cssClass="form-element"
					...
					<div class="col-md-6">
						...
						<aui:input name="phoneNumber" class="form-element"
							value="${employee.phoneNumber}" cssClass="form-element"
							placeholder="Enter your phone number" label="Phone">
							<aui:validator name="required" />
				...
				<div class="row">
					<div class="col-md-6">
						<aui:input name="addressLine1" class="form-element"
							cssClass="form-element" value="${employee.addressLine1}"
					...
					<div class="col-md-6">
						...
						<aui:input name="addressLine2" class="form-element"
							value="${employee.addressLine2}" cssClass="form-element"
				...
				<div class="row">
					<div class="col-md-6">
						<aui:input name="city" class="form-element"
							value="${employee.city}" cssClass="form-element"
					...
					<div class="col-md-6">
						<aui:input name="zipCode" class="form-element"
							cssClass="form-element" value="${employee.zipCode}"
